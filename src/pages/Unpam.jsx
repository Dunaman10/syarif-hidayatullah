...
const Unpam = () => {
  ...
  const certificates = [
    { id: 1, title: "AI dan Blockchain Pilar Utama Personal Branding Mahasiswa", file: Certi_1 },
    { id: 2, title: "Artificial Intelligence As Smart Solutions For Indonesia's Future", file: Certi_2 },
    { id: 3, title: "Big Data Analysis and Cyber Security", file: Certi_3 },
    { id: 4, title: "Digital Entrepreneurship Innovation", file: Certi_4 },
    { id: 5, title: "Masa Depan Web Development", file: Certi_5 },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={headerRef} className="mb-12">
          ...
          <h1 className="heading-display text-3xl sm:text-4xl lg:text-5xl text-[var(--color-text-primary)]">
            Universitas <span className="text-gradient">Pamulang</span>
          </h1>
          <p className="mt-4 text-[var(--color-text-secondary)]">
            {certificates.length} certificates earned from Universitas Pamulang seminars and workshops.
          </p>
        </div>
