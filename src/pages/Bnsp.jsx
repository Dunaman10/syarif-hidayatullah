...
const Bnsp = () => {
  ...
  const certificates = [
    { id: 1, title: "Certificate Of Competence BNSP", file: Certi_1 },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={headerRef} className="mb-12">
          ...
          <h1 className="heading-display text-3xl sm:text-4xl lg:text-5xl text-[var(--color-text-primary)]">
            <span className="text-gradient">BNSP</span>
          </h1>
          <p className="mt-4 text-[var(--color-text-secondary)]">
            {certificates.length} certificate earned from Badan Nasional Sertifikasi Profesi.
          </p>
        </div>
