...
const Dicoding = () => {
  ...
  const certificates = [
    { id: 1, title: "Belajar Dasar Pemrograman Web", file: Certi_1 },
    { id: 2, title: "Belajar Dasar Git dengan Github", file: Certi_2 },
    { id: 3, title: "Memulai Pemrograman untuk Menjadi Pengembang Software", file: Certi_3 },
    { id: 4, title: "Meniti Karier sebagai Software Developer", file: Certi_4 },
    { id: 5, title: "Pengenalan Data pada Pemrograman Data 101", file: Certi_5 },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={headerRef} className="mb-12">
          ...
          <h1 className="heading-display text-3xl sm:text-4xl lg:text-5xl text-[var(--color-text-primary)]">
            <span className="text-gradient">Dicoding</span>
          </h1>
          <p className="mt-4 text-[var(--color-text-secondary)]">
            {certificates.length} certificates earned from Dicoding Indonesia learning platform.
          </p>
        </div>
