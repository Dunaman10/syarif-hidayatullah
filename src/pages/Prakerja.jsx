...
const Prakerja = () => {
  ...
  const certificates = [
    { id: 1, title: "Langkah untuk Berbisnis E-Commerce", file: Certi_1 },
    { id: 2, title: "Fundamental UI Design dengan Figma", file: Certi_2 },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={headerRef} className="mb-12">
          ...
          <h1 className="heading-display text-3xl sm:text-4xl lg:text-5xl text-[var(--color-text-primary)]">
            <span className="text-gradient">Prakerja</span>
          </h1>
          <p className="mt-4 text-[var(--color-text-secondary)]">
            {certificates.length} certificates earned from Kartu Prakerja program.
          </p>
        </div>
