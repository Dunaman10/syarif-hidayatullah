...
const AlibabaCloud = () => {
  ...
  const certificates = [
    { id: 1, title: "Alibaba Cloud Fundamental Training IDN", file: Certi_1 },
    { id: 2, title: "Build your own personal AI chatbot for your websites in 60 mins", file: Certi_2 },
    { id: 3, title: "Dive Into Generative AI", file: Certi_3 },
    { id: 4, title: "Getting to Know Basic Services of Alibaba Cloud", file: Certi_4 },
    { id: 5, title: "Getting to Know Generative AI and its Concepts", file: Certi_5 },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={headerRef} className="mb-12">
          ...
          <h1 className="heading-display text-3xl sm:text-4xl lg:text-5xl text-[var(--color-text-primary)]">
            Alibaba <span className="text-gradient">Cloud</span>
          </h1>
          <p className="mt-4 text-[var(--color-text-secondary)]">
            {certificates.length} certificates earned from Alibaba Cloud learning programs.
          </p>
        </div>
