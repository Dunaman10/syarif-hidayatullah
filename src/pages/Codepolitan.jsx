...
const Codepolitan = () => {
  ...
  const certificates = [
    { id: 1, title: "Pengembangan Web Fullstack dengan Laravel 11", file: Certi_1 },
    { id: 2, title: "Belajar React.js dengan Membuat Aplikasi Split Bill", file: Certi_2 },
    { id: 3, title: "Membuat UI UX Modern menggunakan AlpineJs", file: Certi_3 },
    { id: 4, title: "React.js - Bagaimana React.js Bekerja di Balik Layar", file: Certi_4 },
    { id: 5, title: "React.js - Belajar Lebih Dalam Tentang Component dan Jenisnya", file: Certi_5 },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={headerRef} className="mb-12">
          ...
          <p className="mt-4 text-[var(--color-text-secondary)]">
            {certificates.length} certificates earned from Codepolitan learning platform.
          </p>
        </div>
